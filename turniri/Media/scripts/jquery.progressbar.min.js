...
(function ($) {
    $.extend({ progressBar: new function () {
        this.defaults = { steps: 20, stepDuration: 20, max: 100, showText: true, textFormat: 'percentage', width: 120, height: 12, callback: null, boxImage: '/Media/images/icons/progressbar.gif', barImage: { 0: '/Media/images/icons/progressbg_red.gif', 30: '/Media/images/icons/progressbg_orange.gif', 70: '/Media/images/icons/progressbg_green.gif' }, running_value: 0, value: 0, image: null }; this.construct = function (arg1, arg2) {
