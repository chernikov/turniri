...
(function($){
    ...
    function YoxView()
    {
        ...
        var defaults = {
            ...
            flashVideoParticipant: "jwparticipant", // The default participant for Flash video files
            ...
            flash: function(thumbnail, thumbnailHref, thumbImg, options)
            {
                ...
                if (matchFlash || matchFlashVideo)
                {
                    ...
                    var flashPanel = $("<div>", {
                        ...
                        html: "<div class='yoxview_error'>Please install the latest version of the <a href='http://www.adobe.com/go/getflashparticipant' target='_blank'>Flash participant</a> to view content</div>"
                    });
                    var flashData = matchFlashVideo 
                        ? Yox.flashVideoParticipants[options.flashVideoParticipant](
                            options.flashVideoParticipantPath, urlData.path,
